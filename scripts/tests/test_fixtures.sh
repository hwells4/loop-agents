...
test_work_fixtures_exist() {
  assert_dir_exists "$LOOPS_DIR/work/fixtures" "work fixtures directory exists"
  assert_file_exists "$LOOPS_DIR/work/fixtures/default.txt" "work default fixture exists"
  assert_file_exists "$LOOPS_DIR/work/fixtures/status.json" "work status template exists"
}

test_improve_plan_fixtures_exist() {
  assert_dir_exists "$LOOPS_DIR/improve-plan/fixtures" "improve-plan fixtures directory exists"
  assert_file_exists "$LOOPS_DIR/improve-plan/fixtures/default.txt" "improve-plan default fixture"
  assert_file_exists "$LOOPS_DIR/improve-plan/fixtures/iteration-1.txt" "improve-plan iteration 1"
  assert_file_exists "$LOOPS_DIR/improve-plan/fixtures/iteration-2.txt" "improve-plan iteration 2"
  assert_file_exists "$LOOPS_DIR/improve-plan/fixtures/iteration-3.txt" "improve-plan iteration 3"
}

test_elegance_fixtures_exist() {
  assert_dir_exists "$LOOPS_DIR/elegance/fixtures" "elegance fixtures directory exists"
  assert_file_exists "$LOOPS_DIR/elegance/fixtures/default.txt" "elegance default fixture"
  assert_file_exists "$LOOPS_DIR/elegance/fixtures/status.json" "elegance status template"
}

test_idea_wizard_fixtures_exist() {
  assert_dir_exists "$LOOPS_DIR/idea-wizard/fixtures" "idea-wizard fixtures directory exists"
  assert_file_exists "$LOOPS_DIR/idea-wizard/fixtures/default.txt" "idea-wizard default fixture"
  assert_file_exists "$LOOPS_DIR/idea-wizard/fixtures/status.json" "idea-wizard status template"
}

test_refine_beads_fixtures_exist() {
  assert_dir_exists "$LOOPS_DIR/refine-beads/fixtures" "refine-beads fixtures directory exists"
  assert_file_exists "$LOOPS_DIR/refine-beads/fixtures/default.txt" "refine-beads default fixture"
  assert_file_exists "$LOOPS_DIR/refine-beads/fixtures/status.json" "refine-beads status template"
}
...
test_improve_plan_status_sequence() {
  ...
  local fixtures="$LOOPS_DIR/improve-plan/fixtures"
